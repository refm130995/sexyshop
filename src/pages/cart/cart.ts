...
export class CartPage {
    ...
    Apply: any;
    Checkout: any;
    constructor(public nav: NavController, public service: CartService, public values: Values, public params: NavParams, public functions: Functions, public loading: LoadingController) {
        this.Apply = "Apply";
    ...
    submitCoupon() {
        this.mensaje('Aplicando cupón');

        console.log('cart.coupon', this.cart.coupon);
    ...
    handleCoupon(results) {
        ...
        this.Apply = "Aplicar";
        this.functions.showAlert("Mensaje", results._body);
        this.service.loadCart()
            .then((results) => this.handleCart(results));
    }

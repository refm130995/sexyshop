...
export class BillingAddressForm {
    ...
    checkout() {
        ...
        this.buttonText = "Realizando pedido...";
    ...
    handlePayment(results) {
        this.loader = this.loading.create({
            content: 'La ventana de pagos puede tardar más de 10 segundos en cargarse, por favor ten paciencia y espera un poco sin cerrar la aplicación',
            duration: 12000,
            spinner: 'crescent',
            showBackdrop: true
          }).present();
        ...
        if (results.result == 'success') {
            ...
            this.functions.showAlert("ESTATUS", results.messages);
            this.buttonSubmit = false;
        }
    }
    checkoutStripe() {
    ...
    handleResults(a) {
        ...
        if (a.user_logged) {
            ...
            this.functions.showAlert("Hubo un problema", 'No se pudo iniciar la sesión, por favor intente nuevamente');
        }
    }
    submitCoupon() {
        this.buttonSubmitCoupon = true;
        this.buttonText1 = "Cargando";
    ...
    changePayment() {
        ...
        this.buttonSubmit = false;
        this.buttonText = "Continuar a " + this.form.payment[this.form.payment_method].method_title;
    }
    ...
    checkoutAlert(){
        const confirm = this.alertCtrl.create({
            title: 'Importante',
            message: 'La ventana de pagos puede tardar más de 10 segundos en cargarse, por favor ten paciencia y espera un poco sin cerrar la aplicación',
            buttons: [
              {
                text: 'Entendido',
                handler: () => {

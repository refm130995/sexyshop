...
export class ProductsPage {
    ...
    categoryName: any;
    Ordenar: any;
    constructor(public alertCtrl: AlertController, public nav: NavController, public popoverCtrl: PopoverController, public service: CategoryService, params: NavParams, public values: Values, public functions: Functions) {
        this.data = {};
        this.filter = {};
        this.q = "";
    ...
    addToWishlist(id) {
        if (this.values.isLoggedIn) {
            ...
            this.functions.showAlert("Importante", "Debes iniciar sesión para poder crear una lista de deseos");
        }
    }
    update(results, id) {
    ...
    showConfirm() {
        let titulo = 'Producto agregado la cesta';
        //let msg = '';
